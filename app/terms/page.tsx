export default function TermsOfService() {
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px', fontFamily: 'sans-serif', lineHeight: 1.7, color: '#1a1a1a' }}>
      <h1 style={{ fontSize: 32, fontWeight: 700, marginBottom: 8, color: '#0D2818' }}>Terms of Service</h1>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>2. Acceptance of Terms</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>3. Eligibility</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>4. Account Registration</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>5. Genotype Information</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>6. User Conduct</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>7. Matching and Communication</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>8. Privacy</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>9. Intellectual Property</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>10. Disclaimers</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>11. Limitation of Liability</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>12. Termination</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>13. Changes to Terms</h2>
      <p>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>14. Contact</h2>
      <p>
