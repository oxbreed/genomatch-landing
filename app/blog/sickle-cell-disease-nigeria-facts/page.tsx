  ...
  return (
    <div style={{ background: LINEN, minHeight: '100vh', fontFamily: 'Georgia, serif' }}>
      ...
      <article style={{ maxWidth: '720px', margin: '0 auto', padding: '80px 24px' }}>
        ...
        <span style={{ background: LINEN, color: FOREST, fontSize: '11px', letterSpacing: '1px', padding: '4px 12px', borderRadius: '99px', fontFamily: 'Arial, sans-serif', fontWeight: 700, border: `1px solid rgba(22,53,34,0.15)` }}>Public Health</span>
        ...
        <div style={{ color: '#2A4A35', fontSize: '18px', lineHeight: 1.9, fontFamily: 'Arial, sans-serif' }}>
          ...
          <div style={{ background: FOREST, borderRadius: '16px', padding: '40px', textAlign: 'center' }}>
            ...
            <p style={{ color: SAGE, marginBottom: '24px', fontFamily: 'Arial, sans-serif' }}>Join GenoMatch and help normalise genotype awareness in Nigeria and across the diaspora.</p>
