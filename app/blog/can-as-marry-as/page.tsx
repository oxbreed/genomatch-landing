export const metadata = {
  title: 'Can AS Marry AS? The Truth About Sickle Cell Risk — GenoMatch',
  ...
  return (
    <div style={{ background: LINEN, minHeight: '100vh', fontFamily: 'Georgia, serif' }}>
      ...
      <article style={{ maxWidth: '720px', margin: '0 auto', padding: '80px 24px' }}>
        ...
        <span style={{ background: LINEN, color: FOREST, fontSize: '11px', letterSpacing: '1px', padding: '4px 12px', borderRadius: '99px', fontFamily: 'Arial, sans-serif', fontWeight: 700, border: `1px solid rgba(22,53,34,0.15)` }}>Sickle Cell Awareness</span>
        ...
        <p style={{ color: SAGE, fontSize: '14px', fontFamily: 'Arial, sans-serif', marginBottom: '48px' }}>June 2026 · 6 min read · GenoMatch</p>
        ...
        <div style={{ color: '#2A4A35', fontSize: '18px', lineHeight: 1.9, fontFamily: 'Arial, sans-serif' }}>
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '16px', padding: '16px 0', borderBottom: i < 2 ? '1px solid rgba(22,53,34,0.08)' : 'none' }}>
                ...
                <div>
                  ...
                  <div style={{ color: '#4A6355', fontSize: '15px' }}>{row.desc}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ background: FOREST, borderRadius: '16px', padding: '40px', textAlign: 'center' }}>
            ...
            <p style={{ color: SAGE, marginBottom: '24px', fontFamily: 'Arial, sans-serif' }}>Join the GenoMatch waitlist and be first to experience intentional, informed dating.</p>
