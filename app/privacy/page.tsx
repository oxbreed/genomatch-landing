export default function PrivacyPolicy() {
  return (
    <main style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px', fontFamily: 'sans-serif', lineHeight: 1.7, color: '#1a1a1a' }}>
      <h1 style={{ fontSize: 32, fontWeight: 700, marginBottom: 8, color: '#0D2818' }}>Privacy Policy</h1>
      <p style={{ color: '#666', marginBottom: 40 }}>Last updated: June 2026</p>

      <h2 style={{ color: '#0D2818', marginTop: 32 }}>1. Introduction</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>2. Who We Are</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>3. What Data We Collect</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>4. Why We Collect Your Data</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>5. Legal Basis for Processing</h2>
      <p>We process your data on the basis of contract, consent, legitimate interests, and legal obligation.</p>

      <h2 style={{ color: '#0D2818', marginTop: 32 }}>6. How We Store Your Data</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>7. Who We Share Your Data With</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>8. Your Rights</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>9. Account Deletion</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>10. Data Retention</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>11. Children's Privacy</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>14. International Data Transfers</h2>
      ...
      <h2 style={{ color: '#0D2818', marginTop: 32 }}>15. Changes to This Policy</h2>
